...
class AccountAssetAsset(models.Model):
    ...
    value = fields.Float(string='Gross Value',  readonly=True, digits=0, states={'draft': [('readonly', False)]})
    ...
    note = fields.Text()
    category_id = fields.Many2one('account.asset.category', string='Category',  change_default=True, readonly=True, states={'draft': [('readonly', False)]})
