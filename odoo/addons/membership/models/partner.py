...
class Partner(models.Model):
    ...
    project_ids=fields.Many2many('project.project', 'project_project_res_partner_rel', 'partner_id', 'project_id')
            ...
            if state == 'none':
                for mline in partner.member_lines:
                    ...
                    if ((mline.date_from or date.min) < today and (mline.date_to or date.min) < today and \
                            ...
                            mline.account_invoice_id and mline.account_invoice_id.invoice_payment_state in ('in_payment', 'paid')):
                        state = 'old'
                        break
