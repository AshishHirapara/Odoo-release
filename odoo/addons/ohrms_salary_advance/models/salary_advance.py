...
class SalaryAdvancePayment(models.Model):
    ...
    def approve_request(self):
        ...
        employee_contract_id = self.env['hr.contract'].search([])
        for cont in employee_contract_id:
           if cont.employee_id.id == self.employee_id.id:
                self.employee_contract_id = cont.id
